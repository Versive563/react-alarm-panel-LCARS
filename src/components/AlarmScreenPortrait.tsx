...
export interface AlamrScreenPortraitProps {
    id: string;
    title: string;
    subTitle: string;
    width: number;
...
export interface AlamrScreenPortraitState {
    color: any;
    visible: boolean;
}

class AlamrScreenPortrait<P extends AlamrScreenPortraitProps> extends Component<P> {
    ...
    state: AlamrScreenPortraitState;
...
export default AlamrScreenPortrait;